...
def train_model(
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        model_name,
        num_labels=4  # 0: normal, 1: offensive, 2: hateful, 3: spam
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--data_path',
        type=str,
        default='../data_comment_moderation_project.jsonl',
    ...
    parser.add_argument(
        ...
        help='Pretrained model name (vinai/phobert-base or vinai/phobert-large)'
    )
    parser.add_argument(
        '--batch_size',
        type=int,
